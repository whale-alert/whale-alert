...
| **Enterprise API** | Live alerts | 90 days rolling | Alerts: 10,000/h <br />API Calls: 1,000+ CPM | Quantitative trading, data pipelines, short-term backfills. |
| **Enterprise Plus API** | Live alerts | Full history (Genesis to present)* | Alerts: 20,000/h <br />API Calls: 2,000+ CPM  | Macro research, long-term backtesting, institutional compliance. |
...
| **02. Wallet Watcher** | Track specific addresses and contract interactions across chains. | [Go](https://github.com/whale-alert/whale-alert-examples/tree/main/go/02_wallet_watcher) | [Python](https://github.com/whale-alert/whale-alert-examples/tree/main/python/02_wallet_watcher) | All Plans |
| **03. Exchange Flow Signals** | Classify exchange inflows (deposits) and outflows (withdrawals). | [Go](https://github.com/whale-alert/whale-alert-examples/tree/main/go/03_exchange_flow_signals) | [Python](https://github.com/whale-alert/whale-alert-examples/tree/main/python/03_exchange_flow_signals) | All Plans |
| **04. Enterprise Historical Query** | Query past transactions with cursor pagination and volume aggregation. | [Go](https://github.com/whale-alert/whale-alert-examples/tree/main/go/04_enterprise_historical_query) | [Python](https://github.com/whale-alert/whale-alert-examples/tree/main/python/04_enterprise_historical_query) | Enterprise / Full Enterprise |
| **05. Multi-Chain Dynamic Filter** | Filter by chain and apply per-asset USD thresholds. | [Go](https://github.com/whale-alert/whale-alert-examples/tree/main/go/05_multichain_threshold_filter) | [Python](https://github.com/whale-alert/whale-alert-examples/tree/main/python/05_multichain_threshold_filter) | All Plans |
